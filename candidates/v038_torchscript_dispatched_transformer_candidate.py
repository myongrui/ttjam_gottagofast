"""TorchScript-dispatched transformer candidate.

Hypothesis: scripting the complete transformer stack eliminates repeated Python
module, loop, and operator-dispatch overhead between its many small CUDA kernel
launches. The generated TorchScript graph statically unrolls the layer stack
while preserving centralized attention-mask construction and the exact eager
PyTorch operations.
"""
